...
private:
		...
		SVGMatrix* newMatrix(float a,float b,float c,float d,float e,float f);
		SVGMatrix* newMatrix(const String mvector);
		SVGMatrix* newMatrix(SVGMatrix *a);
		void transformPoint2D(SVGMatrix *mtx,float *a,float *b);
		bool matrixIsNull(SVGMatrix* mtx);
		void composeMatrix(SVGMatrix **mtx,SVGMatrix *mtx1,SVGMatrix *mtx2);
		void multiplyMatrix(SVGMatrix **mtx1,SVGMatrix *mtx2);
