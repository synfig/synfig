/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/software/task/taskchromakeygl.cpp
**	\brief TaskChromaKeyGl
**
**	\legal
**	......... ... 2023 Bharat Sahlot
**
...
#include "modules/mod_filter/chromakey.h"
#include <vector>
...
class TaskChromaKeyGL: public TaskChromaKey, public TaskGL
{
public:
...
Task::Token TaskChromaKeyGL::token(
