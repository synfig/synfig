...
REGISTER_VALUENODE(ValueNode_Bone, RELEASE_VERSION_0_62_00, "bone", _("Bone"))
REGISTER_VALUENODE(ValueNode_Bone_Root, RELEASE_VERSION_0_62_00, "bone_root", _("Root Bone"))
