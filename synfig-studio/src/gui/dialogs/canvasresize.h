...
class CanvasResize : public Gtk::Dialog
{
	...
	bool was_canvas_checked;
	bool is_canvas_checked;
	...
	bool on_canvas_label_enter_event(GdkEventCrossing *event);
	bool on_canvas_label_leave_event(GdkEventCrossing *event);
	bool on_canvas_label_button_event(GdkEventButton *event);
	void on_canvas_only_checked();
