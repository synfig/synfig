...
KeyFrameDial::KeyFrameDial(): Gtk::Table(2, 1, false)
{
	...
	toggle_keyframe_past = create_icon(Gtk::ICON_SIZE_BUTTON, "synfig-keyframe_lock_past_on",_("Lock past keyframe"));
	toggle_keyframe_future = create_icon(Gtk::ICON_SIZE_BUTTON, "synfig-keyframe_lock_future_on",_("Lock future keyframe"));
