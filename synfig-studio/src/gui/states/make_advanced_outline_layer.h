/* === S Y N F I G ========================================================= */
/*!	\file make_advanced_outline_layer.h
...
#ifndef __SYNFIG_STUDIO_MAKE_ADVANCED_OUTLINE_LAYER_H
#define __SYNFIG_STUDIO_MAKE_ADVANCED_OUTLINE_LAYER_H
...
class MakeAdvancedOutlineLayer : public MakeLayer {
public:
	MakeAdvancedOutlineLayer(StateShape_Context* context_) :
		MakeLayer(context_)
	{}
