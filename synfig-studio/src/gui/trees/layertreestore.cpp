...
LayerTreeStore::LayerTreeStore(std::shared_ptr<synfigapp::CanvasInterface> canvas_interface_):
...
LayerTreeStore::create(std::shared_ptr<synfigapp::CanvasInterface> canvas_interface_)
{
