/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/common/task/tasksurfaceconvert.h
**	\brief TaskSurfaceConvert Header
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_RENDERING_TASKSURFACECONVERT_H
#define __SYNFIG_RENDERING_TASKSURFACECONVERT_H
