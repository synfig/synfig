...
public:
	...
	bool get_waypoint_mouse_copy() { return waypoint_mouse_copy; }
	void set_waypoint_mouse_copy(bool copy) { waypoint_mouse_copy = copy; }
...
private:
	...
	void on_no_waypoint_clicked(unsigned int button, Gdk::Point button_coord);
