/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/software/task/taskpixelcolormatrixsw.h
**	\brief TaskPixelColorMatrixSW Header
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_RENDERING_TASKPIXELCOLORMATRIXSW_H
#define __SYNFIG_RENDERING_TASKPIXELCOLORMATRIXSW_H
