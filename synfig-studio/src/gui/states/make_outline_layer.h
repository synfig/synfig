...
#ifndef __SYNFIG_STUDIO_MAKE_OUTLINE_LAYER_H
#define __SYNFIG_STUDIO_MAKE_OUTLINE_LAYER_H
...
class MakeOutlineLayer : public MakeLayer {
public:
	MakeOutlineLayer(StateShape_Context* context_) :
		MakeLayer(context_)
	{}
