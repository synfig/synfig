...
Widget_Time*
FrameDial::create_entry()
{
  set_end_time = manage(new Widget_Time());
  set_end_time->set_width_chars(3);
	set_end_time->set_tooltip_text(_("Set end time"));
	set_end_time->show();
	add(*set_end_time);
  return set_end_time;
}
