/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/common/optimizer/optimizertransformationaffine.h
**	\brief OptimizerTransformationAffine Header
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_RENDERING_OPTIMIZERTRANSFORMATIONAFFINE_H
#define __SYNFIG_RENDERING_OPTIMIZERTRANSFORMATIONAFFINE_H
