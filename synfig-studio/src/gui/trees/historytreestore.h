...
public:
	...
	{
	public:
		Gtk::TreeModelColumn<std::shared_ptr<synfigapp::Action::Undoable> > action;
...
private:
	...
	void insert_action(Gtk::TreeRow row, std::shared_ptr<synfigapp::Action::Undoable> action, bool is_undo=true, bool is_redo=false);
...
private:
	...
	void on_new_action(std::shared_ptr<synfigapp::Action::Undoable> action);

	void on_action_status_changed(std::shared_ptr<synfigapp::Action::Undoable> action);
