/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/common/optimizer/optimizerpixelprocessorsplit.h
**	\brief OptimizerPixelProcessorSplit Header
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_RENDERING_OPTIMIZERPIXELPROCESSORSPLIT_H
...
class OptimizerPixelProcessorSplit: public Optimizer
{
public:
