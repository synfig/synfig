...

{
	...
	entry_threshold.set_hexpand(true);
	...
	entry_accuracy.set_hexpand(true);
	...
	entry_despeckling.set_hexpand(true);
	...
	entry_maxthickness.set_hexpand(true);
	...
	Centerline_setting_grid->set_column_homogeneous(false);	
