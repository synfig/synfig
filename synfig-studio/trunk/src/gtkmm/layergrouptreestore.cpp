...
LayerGroupTreeStore::on_activity()
{
	...
	if(!rebuilding && canvas_interface()->get_instance()->get_most_recent_action_name() && canvas_interface()->get_instance()->get_most_recent_action_name().find("Group")!=String::npos)
	try
	{
