...
SVGMatrix*
Svg_parser::newMatrix(SVGMatrix *a){
	SVGMatrix* data;
...
void
Svg_parser::composeMatrix(SVGMatrix **mtx,SVGMatrix* mtx1,SVGMatrix* mtx2){
	SVGMatrix* aux=newMatrix(0,0,0,0,0,0);
...
void
Svg_parser::multiplyMatrix(SVGMatrix **mtx1,SVGMatrix *mtx2){
	SVGMatrix* aux=newMatrix(0,0,0,0,0,0);
	aux->a=((*mtx1)->a)*(mtx2->a)+((*mtx1)->c)*(mtx2->b);
	aux->b=((*mtx1)->b)*(mtx2->a)+((*mtx1)->d)*(mtx2->b);
	aux->c=((*mtx1)->a)*(mtx2->c)+((*mtx1)->c)*(mtx2->d);
