...
void
Dock_CanvasSpecific::init_canvas_view_vfunc(CanvasView::LooseHandle /*canvas_view*/)
{
}
...
void
Dock_CanvasSpecific::changed_canvas_view_vfunc(CanvasView::LooseHandle /*canvas_view*/)
{
}
