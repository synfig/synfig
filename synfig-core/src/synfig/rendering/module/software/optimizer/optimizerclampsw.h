/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/module/software/optimizer/optimizerclampsw.h
**	\brief OptimizerClampSW Header
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_RENDERING_OPTIMIZERCLAMPSW_H
...
class OptimizerClampSW: public Optimizer
{
public:
	OptimizerClampSW()
	{
