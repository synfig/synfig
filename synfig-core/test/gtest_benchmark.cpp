/* === S Y N F I G ========================================================= */
/*!	\file gtest_benchmark.cpp
**	\brief Benchmark test (Google Test)
**
**	\legal
...
TEST(BenchmarkTest, HermiteFloat)
{
	float f; int i;
...
TEST(BenchmarkTest, HermiteDouble)
{
	int i;
	float f;
...
TEST(BenchmarkTest, HermiteAngle)
{
	using namespace synfig;
