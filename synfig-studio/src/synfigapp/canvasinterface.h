...
private:
	...
	sigc::signal<void,synfig::Layer::Handle,bool> signal_layer_z_depth_range_changed_;
...
public:	// Signal Interface
	...
	sigc::signal<void,synfig::Layer::Handle,bool>& signal_layer_z_depth_range_changed() { return signal_layer_z_depth_range_changed_; }
