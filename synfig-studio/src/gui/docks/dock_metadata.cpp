...
void
Dock_MetaData::init_canvas_view_vfunc(std::shared_ptr<CanvasView> canvas_view)
{
...
void
Dock_MetaData::changed_canvas_view_vfunc(std::shared_ptr<CanvasView> canvas_view)
{
	if(canvas_view)
	{
