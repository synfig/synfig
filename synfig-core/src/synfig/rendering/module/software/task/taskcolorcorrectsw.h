/* === S Y N F I G ========================================================= */
/*!	\file synfig/rendering/module/software/task/taskcolorcorrectsw.h
**	\brief TaskColorCorrectSW Header
**
**	$Id$
**
**	\legal
...
#ifndef __SYNFIG_RENDERING_MODULE_TASKCOLORCORRECTSW_H
#define __SYNFIG_RENDERING_MODULE_TASKCOLORCORRECTSW_H

/* === H E A D E R S ======================================================= */

#include "../../common/task/taskcolorcorrect.h"
...
class TaskColorCorrectSW: public TaskColorCorrect, public TaskSW, public TaskSplittable
{
private:
