...
synfig::Layer::Handle
Layer_Skeleton::hit_check(synfig::Context context, const synfig::Point &point)const
{
	...
	return const_cast<Layer_Skeleton*>(this);
}

Real
Layer_Skeleton::densityfunc(const synfig::Point &p, const synfig::Point &c, Real R)const
{
...
Real
Layer_Skeleton::totaldensity(const Point &pos)const
{
	Real density = 0;
...
Color
Layer_Skeleton::get_color(Context context, const Point &pos)const
{
