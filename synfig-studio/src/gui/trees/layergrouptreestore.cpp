...
void
LayerGroupTreeStore::on_group_pair_added(synfig::String group, std::shared_ptr<synfig::Layer> layer)
{
	if(!layer->get_canvas())
		return;
	Gtk::TreeModel::Children::iterator iter;
...
void
LayerGroupTreeStore::on_group_pair_removed(synfig::String group, std::shared_ptr<synfig::Layer> layer)
{
	if(!layer->get_canvas())
		return;
	Gtk::TreeModel::Children::iterator iter;
